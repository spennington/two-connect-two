 ...
 *
 */
public class ColumnWinSearcher {
	...
	private static int isWin(Board board, int col, int row) {
	...
	private static byte score(byte a, byte b, byte c, byte d) {
		return scoreMap[(a << 6) | (b << 4) | (c << 2) | d];
	}
	
	public static int[][] getColumnScores(Board board) {
